...
replace github.com/LayerTwo-Labs/sidesail/sidechain-orchestrator => ../vendor/sidechain-orchestrator

replace github.com/LayerTwo-Labs/sidesail/coinnews/codec => ../vendor/coinnews/codec
