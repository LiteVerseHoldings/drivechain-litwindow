...
Once, I remarked that DC-withdrawals are probably "more secure" than regular Litecoin transactions.
...
The engineering task of "how to sidechain", is basically the task of "how to most efficiently abandon the mainchain host software". Ie, how to abandon Litecoin Core (without destroying Litecoin Core, or harming the 21 million LTC).

The problem is that Litecoin-Culture has evolved [an extreme aversion to all non-LTC projects](https://www.reddit.com/r/ltc/comments/9i8obh/everything_wrong_with_the_ltc_community_in_one/).
...
The problem, is that –in order to actually launch [my real project](http://www.litecoinhivemind.com/)– I inadvertently need to create the Real First Litecoin Prodution Sidechain. So, while I would much prefer to avoid contradicting Blockstream, in practice this is not possible. There's just no way to tell the truth about Drivechain without contradicting Blockstream.
...
[^n]: Much of it is cognitive dissonance – it is the only way someone can process a world, where they work hard to make obscure and under-appreciated changes to Litecoin, while meanwhile the ICO scam down the street gets $30 million dollars in a weekend.
