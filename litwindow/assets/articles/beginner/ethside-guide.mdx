...
We show how to use Eth's software stack, but with LTC. (Ie, without buying Ether). This requires Bip300, but we can still demonstrate via DriveNet (a version of Litecoin Core with Bip300 activated).
