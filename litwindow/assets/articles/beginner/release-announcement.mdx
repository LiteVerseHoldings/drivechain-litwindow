...
1. Litecoin Core 16.99, [modified to support drivechain technology](https://github.com/drivechain-project/diff).
2. Litecoin Core 16.99, modified to be a vanilla, minimalist, 'blank' sidechain. It is a very boring sidechain, whose capabilities are the same as Litecoin Core's.
...
Nonetheless, it's good to be able to show people what exactly Drivechain does: it allows Litecoin to travel among different pieces of software.

## Implications

If this "multi-network coin" idea is found to be viable, it has profound implications for the crypto's most salient problems. **Litecoin would be able to copy, without controversy, any technology**, including: larger blocks, Turing-completeness, and ring signatures.

As a result:

- There would be no need to fight about which features Litecoin "should" have (or over which features "define" Litecoin).
- Technologists would be free to build interesting blockchain technology and add it to Litecoin, without going through the arduous/political review process.
